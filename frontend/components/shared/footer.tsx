          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="mt-6 space-y-3">
              <div className="flex items-start gap-3 text-white/80">
                <svg className="h-5 w-5 mt-0.5 text-accent flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-sm">106-38 Guy R Brewer Blvd,<br/>Jamaica, NY 11433</span>
              </div>
              <div className="flex items-center gap-3 text-white/80">
                <Icon name="phone" className="h-5 w-5 text-accent flex-shrink-0" />
                <a href="tel:+19296911930" className="text-sm font-bold hover:text-accent transition-colors">+1 (929) 691-1930</a>
              </div>
            </div>

            <div className="mt-8 flex items-center gap-3">
              <Link href="#" className="bg-white/5 hover:bg-accent text-white border border-white/10 p-2.5 rounded-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-accent/30 group">
